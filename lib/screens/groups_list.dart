...
class _GroupsListState extends State<GroupsList> {
    ...
    Future.delayed(Duration(milliseconds: 1000), () {
      ...
      _scrollController.addListener(() {
        ...
        if (maxScroll - currentScroll <= delta * 0.2) {
          ...
          //   print(userData!["role"]);
          // });
          !isLoading && userData!["role"] == "mentor"
  ...
  String DateTimeFormatNotification(String dateString) {
    ...
    if (DateTime.now().toString().substring(0, 10) == str) {
      reverseString = DateFormat.jm()
          .format(DateFormat("hh:mm:ss").parse(
              "${dateString[11]}${dateString[12]}:"
              "${dateString[14]}${dateString[15]}:${dateString[17]}${dateString[18]}"))
          .toString();
                                                          ...
                                                          child: Row(
                                                            ...
                                                            children: [
                                                              CircleAvatar(
                                                                radius: 25,
                                                                backgroundImage:
                                                                    CachedNetworkImageProvider(snapshotGroupList
                                                                            .data!
                                                                            .docs[index]
                                                                        [
                                                                        "icon"]),
                                                                  ...
                                                                  builder: (
                                                                    ...
                                                                    if (snapshot
                                                                      ...
                                                                      if (snapshot
                                                                          ...
                                                                          documentSnapshot
                                                                              .data!
                                                                              .data()!['groupChatCount'][_auth.currentUser!.uid]) {
                                                                        return StreamBuilder(
                                                                            stream: FirebaseFirestore.instance
                                                                                .collection('groups')
                                                                            ...
                                                                            builder: (context, AsyncSnapshot<QuerySnapshot<Map<String, dynamic>>> snap) {
                                                                              return Column(
                                                                                ...
                                                                                children: [
                                                                                  ...
                                                                                  // )
                                                                                  //     : SizedBox(),
                                                                                  Text("${DateTimeFormatNotification(snap.data!.docs[index]["time"].toDate().toString())}", style: TextStyle(fontSize: 6, fontFamily: "Regular", fontWeight: FontWeight.bold, color: HexColor("7A7A7C")), overflow: TextOverflow.ellipsis),
                                                                                  SizedBox(
                                                                                    height: 3,
                                                                                  ),
                                                                                  CircleAvatar(
                                                                                    ...
                                                                                    child:
                                                                                      ...
                                                                                      child: Text(
                                                                                        ...
                                                                                        style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 11, fontFamily: "Regular"),
                                                                                      ),
                                                                                    ),
                                                                                    // ),
                                                                                  ),
